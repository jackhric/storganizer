...
var CreateItems = app.Migration{
	...
	Up: func(app core.App) error {
		...
		col.Fields.Add(&core.TextField{Name: itemconsts.FieldDescription})
		col.Fields.Add(&core.NumberField{Name: itemconsts.FieldQuantity, Required: true})
		...
		col.Fields.Add(&core.TextField{Name: itemconsts.FieldCategory})
		col.Fields.Add(&core.TextField{Name: itemconsts.FieldDatasheetURL})
		return app.Save(col)
	},
